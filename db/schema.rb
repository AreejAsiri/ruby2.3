...
ActiveRecord::Schema.define(version: 20200327052250) do
  ...
  add_index "activity_types", ["abbreviation"], name: "index_activity_types_on_abbreviation", unique: true
  ...
  add_index "breaks", ["teaching_period_id"], name: "index_breaks_on_teaching_period_id"
  ...
  add_index "campuses", ["active"], name: "index_campuses_on_active"
  ...
  add_index "comments_read_receipts", ["task_comment_id", "user_id"], name: "index_comments_read_receipts_on_task_comment_id_and_user_id", unique: true
  add_index "comments_read_receipts", ["task_comment_id"], name: "index_comments_read_receipts_on_task_comment_id"
  add_index "comments_read_receipts", ["user_id"], name: "index_comments_read_receipts_on_user_id"
  ...
  add_index "group_sets", ["unit_id"], name: "index_group_sets_on_unit_id"
  ...
  add_index "learning_outcome_task_links", ["task_definition_id"], name: "index_learning_outcome_task_links_on_task_definition_id"
  add_index "learning_outcome_task_links", ["task_id"], name: "index_learning_outcome_task_links_on_task_id"
  ...
  add_index "plagiarism_match_links", ["other_task_id"], name: "index_plagiarism_match_links_on_other_task_id"
  add_index "plagiarism_match_links", ["task_id"], name: "index_plagiarism_match_links_on_task_id"
  ...
  add_index "projects", ["campus_id"], name: "index_projects_on_campus_id"
  add_index "projects", ["enrolled"], name: "index_projects_on_enrolled"
  ...
  add_index "task_comments", ["discussion_comment_id"], name: "index_task_comments_on_discussion_comment_id"
  add_index "task_comments", ["reply_to_id"], name: "index_task_comments_on_reply_to_id"
  ...
  add_index "task_definitions", ["tutorial_stream_id"], name: "index_task_definitions_on_tutorial_stream_id"
  ...
  add_index "tasks", ["group_submission_id"], name: "index_tasks_on_group_submission_id"
  add_index "tasks", ["project_id", "task_definition_id"], name: "tasks_uniq_proj_task_def", unique: true
  ...
  add_index "teaching_periods", ["period", "year"], name: "index_teaching_periods_on_period_and_year", unique: true
  ...
  add_index "tutorial_enrolments", ["project_id"], name: "index_tutorial_enrolments_on_project_id"
  add_index "tutorial_enrolments", ["tutorial_id", "project_id"], name: "index_tutorial_enrolments_on_tutorial_id_and_project_id", unique: true
  add_index "tutorial_enrolments", ["tutorial_id"], name: "index_tutorial_enrolments_on_tutorial_id"
  ...
  add_index "tutorial_streams", ["abbreviation", "unit_id"], name: "index_tutorial_streams_on_abbreviation_and_unit_id", unique: true
  add_index "tutorial_streams", ["abbreviation"], name: "index_tutorial_streams_on_abbreviation"
  add_index "tutorial_streams", ["name", "unit_id"], name: "index_tutorial_streams_on_name_and_unit_id", unique: true
  add_index "tutorial_streams", ["unit_id"], name: "index_tutorial_streams_on_unit_id"
  ...
  add_index "tutorials", ["campus_id"], name: "index_tutorials_on_campus_id"
  add_index "tutorials", ["tutorial_stream_id"], name: "index_tutorials_on_tutorial_stream_id"
  ...
  add_index "units", ["teaching_period_id"], name: "index_units_on_teaching_period_id"
